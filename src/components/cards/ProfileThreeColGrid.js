...
export default ({
  ...
  subheading = "Our Team",
  description = "Comprising highly skilled professionals from diverse backgrounds, our team is dedicated to delivering excellence in every project we undertake.",
  cards = [
    {
